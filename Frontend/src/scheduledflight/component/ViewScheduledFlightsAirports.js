...
//min={'${new Date().getDate()<10 ? '0' : ''}${new Date().getDate()}-${(new Date().getMonth()+1)<10 ? '0' : ''}${new Date().getMonth() + 1}+${new Date().getYear() +1900}'}
//min={'${new Date().getDate()<10 ? '0' : ''}${new Date().getDate()}+${new Date().getMonth()<10 ? '0' : ''}${new Date().getMonth() + 1}-${new Date().getFullYear()}'}

                  min={`${new Date().getFullYear()}-${new Date().getMonth()<10 ? '0' : ''}${new Date().getMonth() + 1}-${new Date().getDate()<10 ? '0' : ''}${new Date().getDate()}`}
